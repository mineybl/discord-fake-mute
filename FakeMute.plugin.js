...
class ExampleLibraryPlugin {
    ...
    getName() {return "FakeMute";}
    getDescription() {return "Join voice channel, mute yourself, start and stop plugin, now you can unmute and speak";}
    getVersion() {return "0.1.1";}
    getAuthor() {return "Lupo#1725";}
...
window.BdApi.alert("success",`now stop plugin!, After you turned ON the plugin , you cant join any other voice channels , for this you have to Reload discord with CTRL+R`);
